...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'amountOfChildren' => 'Количество несовершеннолетних детей',
        'maritalStatus' => 'Семейное положение',
        'monthlyIncome' => 'Ежемесячный доход',
        'typeOfEmployment' => 'Тип занятности',
        'realEstate' => 'Есть ли недвижимость',
        'loans' => 'Есть ли непогашенные кредиты',
        'loansDebts' => 'Есть ли задолженности по текущим кредитам',
        'monthlyLoanRepayment' => 'Ежемесячная выплата по текущим кредитам',
    ],
